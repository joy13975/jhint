...
var trigger_use_ctrl = 1;  // 0=no, 1=either, 2=must
var trigger_use_shift = 0;
var trigger_use_alt = 1;
var trigger_use_meta = 0;
var positionX = 0;
var positionY = 0;
...
function doKeyPress(e) {
  if (e.keyCode == close_on_key) {
    removeCard();
  } else if (e.keyCode == trigger_key) {
    if ((trigger_use_ctrl == 1 || (trigger_use_ctrl == 2) == e.ctrlKey) &&
      (trigger_use_shift == 1 || (trigger_use_shift == 2) == e.shiftKey) &&
      (trigger_use_alt == 1 || (trigger_use_alt == 2) == e.altKey) &&
      (trigger_use_meta == 1 || (trigger_use_meta == 2) == e.metaKey)) {
